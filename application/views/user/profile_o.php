				...
				<div class="col-md-8">
					<div class="card-body">
						...
						<p class="card-text">
							<?= $user['nama_program']; ?>
							<br>
							<?= $detail['tempat_lahir'] == NULL ? 'BELUM DIISI' : strtoupper($detail['tempat_lahir']) . ", " . strtoupper(tanggal_indo(date('Y-m-d', $detail['tgl_lahir']))); ?>
							<br>
							<?= $user['gender'] == 1 ? 'IKHWAN' : 'AKHWAT'; ?>
						</p>
						<p class="card-text"><?= $detail['tempat_lahir'] == NULL ? 'BELUM DIISI' : strtoupper($detail['tempat_lahir']) . ", " . strtoupper(tanggal_indo(date('Y-m-d', $detail['tgl_lahir']))); ?></p>
						<p class="card-text"><?= $user['nama_program']; ?></p>
	        	...
	        	<div class="row">
					<div class="col-lg-6">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<textarea name="visi" id="visi" class="form-control font-weight-bold" rows="5"><?= empty($user['alamat']) ? "" : strtoupper($user['alamat']).', '; ?>DESA <?= strtoupper($desa['name']).', KECAMATAN '.strtoupper($kec['name']).', '.strtoupper($kab['name']).', PROVINSI '.strtoupper($prov['name']); ?></textarea>
							</div>
						</div>
					</div>
					<div class="col-lg-6">
