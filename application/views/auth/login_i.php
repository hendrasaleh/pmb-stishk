            ...
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form method="POST" action="<?= base_url('auth/login'); ?>" class="register-form" id="register-form">
                        <h2>Login Aplikasi Pendaftaran Mahasiswa</h2>
                        ...
                        <?= form_error('password', '<small class="text-danger pl-3">', '</small>'); ?>
                            <input type="password" name="password" id="password" value="<?= set_value('password'); ?>" placeholder="Masukkan kata sandi baru" required/>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="reff" id="reff" placeholder="Misal : Dari teman (Ahmad)">
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label for="password1">Kata Sandi :</label>
                            <?= form_error('password1', '<small class="text-danger pl-3">', '</small>'); ?>
                                <input type="password" name="password1" id="password1" value="<?= set_value('password1'); ?>" placeholder="Masukkan kata sandi baru" required/>
                            </div>
                            <div class="form-group">
                                <label for="password2">Ulangi Kata Sandi :</label>
                                <input type="password" name="password2" id="password2" value="<?= set_value('password2'); ?>" placeholder="Ulangi kata sandi baru" required/>
                            </div>
                        </div> -->
                        <div class="form-row">
                        <div align="left" class="form-group">
                            <label>Belum daftar? <a href="<?= base_url('auth'); ?>">Klik di sini!</a></label>
                        </div>
